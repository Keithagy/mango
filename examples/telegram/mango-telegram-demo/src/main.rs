...
use mango_telegram_demo::{ClaudeConversationConfig, UsernameWhitelist, spawn_demo_runtime};
use serde::Deserialize;
use tokio::time::sleep;
use tracing::{error, info};

const CONFIG_FILE_NAME: &str = "telegram-demo.toml";
...
async fn main() -> Result<()> {
    ...
    info!(
        "mango-telegram-demo started with {} allowed usernames using Claude executable {}",
